...
sudo certbot certonly --webroot -w /var/www/certbot --email $DOMAIN_EMAIL -d $DOMAIN -d $API_DOMAIN --cert-name=infosystem_ssl --key-type rsa --rsa-key-size 2048 --agree-tos
